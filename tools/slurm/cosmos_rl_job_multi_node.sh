...
MOUNTS="/lustre:/lustre/,[[REPO_ROOT_PATH]]:/opt/cosmos-rl,${HOME}/.cache/huggingface:/root/.cache/huggingface,[[CONFIG_PATH]]:/opt/cosmos-rl/configs/$(basename [[CONFIG_PATH]])"
...
srun \
    ...
    cd /opt/cosmos-rl
    ./cosmos_rl/launcher/launch_controller.sh --port ${CONTROLLER_PORT} --config configs/$(basename [[CONFIG_PATH]]) [[LAUNCHER]]
    ' \
    &
pid_controller=$!
